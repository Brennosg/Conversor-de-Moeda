...
app = Flask(__name__) # Cria uma instância da classe Flask, que é a aplicação web.
...
def index():
    if request.method == 'POST':
        ...
        resultado = converter_moeda(valor, moeda_origem, moeda_destino) # Chama a função para converter a moeda.
